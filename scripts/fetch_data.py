...
def obtener_datos():
    ...
    # 3. Leaderboards
    # ---------------------------------------
    logger.info("🏆 Guardando leaderboards de todos los actos…")
    ...
    for act in real_acts:
        ...
        try:
            ...
            logger.info(
                f"✔ Guardado — Jugadores: {len(leaderboard.get('players', []))}"
            )

        except Exception as e:
            logger.warning(f"⚠️ No se pudo obtener leaderboard: {e}")
