...
from modules.analytics.application.service import rebuild_all_player_match_analytics


def main():
    parser = argparse.ArgumentParser(
        description="Reconstruye las analytics embebidas en matches.players[].analytics."
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    print(f"embedded_players: {result['embedded_players']}")
