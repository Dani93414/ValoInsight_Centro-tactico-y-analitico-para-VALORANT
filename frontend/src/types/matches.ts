...
export type EconomyMlPlayerRecommendation = {
  ...
  credits_before_buy?: number;
  real_remaining_after_buy?: number;
  real_spent?: number;
  real_loadout_value?: number;
...
export type EconomyMlRoundRecommendation = {
  ...
  delta_round_win?: number | null;
  delta_next_fullbuy?: number | null;
  support_count_best_action?: number | null;
  credit_estimate_quality?: string | null;
  credit_estimate_inconsistency_reason?: string | null;
  team_drop_reconciliation_status?: string | null;
  team_possible_drop_credit_gap?: number | null;
