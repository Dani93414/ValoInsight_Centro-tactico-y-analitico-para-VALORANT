...
export default function HeatmapModal(props: Props) {
  const { onClose } = props;
  const vm = useHeatmapViewModel(props);
  const {
    selectedMapId,
    selectedEvents,
    selectedAgent,
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="modal-panel heatmap-modal-panel">
          {showSetupStep ? (
            <div className="heatmap-setup-screen">
              <div className="heatmap-setup-card">
                <h3 className="heatmap-sidebar-title">
                  Seleccion inicial de filtros
                </h3>
                {filterOptionsError && (
                  <p className="heatmap-options-warning">
                    No se pudieron cargar opciones dinamicas. Se muestran
                    opciones base para que puedas continuar.
                  </p>
                )}
                ...
                <p className="heatmap-sidebar-subtitle">
                  Elige los filtros de arranque del heatmap. Podras cambiarlos
                  despues dentro del modo de visualizacion.
                </p>
                ...
                <div className="heatmap-setup-actions">
                  <button
                    ...
                    onClick={() => setShowSetupStep(false)}
                  >
                    Entrar al heatmap
                  </button>
                </div>
              ...
              <div className="heatmap-main">
                  ...
                  <div className="heatmap-debug-meta">
                    ...
                    {fractureDebugReference && (
                      <span>
                        ...
                        {formatNormValue(fractureDebugReference.normalized_y)})
                        | Δ ({formatNormValue(fractureDebugReference.delta.x)},{" "}
                ...
                {heatmapDebugEnabled && (
                  <div className="heatmap-debug-meta">
                    ...
                    <span>
                      ...
                      {needsSecondary
                        ? ` | derecha=${secondaryEvents.length}`
                        : ""}
                    </span>
                  </div>
                )}
                ...
                {!selectedMapId && (
                  <div className="heatmap-empty">
                    No hay mapa seleccionado. Puedes cambiarlo desde los
                    filtros.
                  </div>
                )}
